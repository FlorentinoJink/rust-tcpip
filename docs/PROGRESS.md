...
# 测试 UDP echo
nc -u 192.168.10.2 8888  # 可以收发 UDP 数据！
# 或使用测试工具
...
- **2025-11-18**: 实现 UDP 协议，协议栈可以收发 UDP 数据！
